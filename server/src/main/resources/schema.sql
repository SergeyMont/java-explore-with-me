...
CREATE TABLE IF NOT EXISTS compilations_events (
    ...
    CONSTRAINT FK_COMPILATIONS_EVENTS_ON_EVENTS FOREIGN KEY (events_id) REFERENCES events (id),
    CONSTRAINT FK_COMPILATIONS_EVENTS_ON_COMPALATIONS FOREIGN KEY (compilation_id) REFERENCES compilations (id)
    );
